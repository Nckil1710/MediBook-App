                        ...
                        {calendarDays.map((d, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className={`py-1.5 sm:py-2 rounded-lg transition-colors ${
                                isPast
                                  ? 'opacity-40 cursor-not-allowed bg-gray-50 text-gray-400'
                                  : 'cursor-pointer hover:bg-teal-100 text-gray-700'
                        ...
                        <div className="flex flex-wrap gap-2">
                          {daySlots.length === 0 ? (
                            ...
                            daySlots.map((slot) => {
                              ...
                              const isPastTime = selectedDate < today || (selectedDate === today && formatTime(slot.startTime) <= new Date().toTimeString().slice(0, 5));
